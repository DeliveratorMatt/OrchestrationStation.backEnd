...
export async function createMusician({ instrument_id, famous_musicians, famous_musicians_url }) {
  const { rows: [musician] } = await db.query(
...
// Create a new piece
export async function createPiece({ instrument_id, famous_excerpts, famous_excerpts_url, score_url }) {
